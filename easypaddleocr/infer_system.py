...
if __name__ == "__main__":
    args = init_args()
    args.add_argument("--det_model_name", type=str)
    args.add_argument("--rec_model_name", type=str)
    args.add_argument("--cls_model_name", type=str)
    args.add_argument("--det_model_config", type=str)
    args.add_argument("--rec_model_config", type=str)
    args.add_argument("--cls_model_config", type=str)
